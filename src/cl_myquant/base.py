...
class MyQuantTrader(BackTestTrader):
    ...
    def open_buy(self, code, opt: Operation):
        ...
        res = order_value(code, use_cash, OrderSide_Buy, OrderType_Market, PositionEffect_Open)
    ...
    def close_buy(self, code, pos: POSITION, opt):
        ...
        if position is None:
            return False
        res = order_target_volume(symbol=code, volume=0, position_side=PositionSide_Long, order_type=OrderType_Market)
